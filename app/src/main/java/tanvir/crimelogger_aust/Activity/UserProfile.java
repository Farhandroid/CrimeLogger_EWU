...
public class UserProfile extends AppCompatActivity {
    ...
    public void initializeKHUDprogress() {
        hud = KProgressHUD.create(UserProfile.this)
    ...
    public void retriveDataFromArraylist() {
        for (int i = 0; i < userPostMCS.size(); i++) {
            if (userPostMCS.get(i).getUserName().equals(userName)) {
                ...
                ///Toast.makeText(this, "user post : "+ userPostData.get(i).getCrimeDesc(), Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void showSheetMenu() {
        SheetMenu.with(this)
                ...
                .setMenu(R.menu.user_profile_option)
                .setAutoCancel(true)
